...
APP_EXE="$HOME/Games/wine/raw/Beast of Reincarnation/BeastOfReincarnation.exe"             # 替换为你的应用路径
PFX_DIR="$HOME/Games/wine/proton/BeastOfReincarnation"       # 独立前缀目录
...
prime-run dlss-swapper-dll "$PROTON_PATH/proton" run "$APP_EXE" -dx11
